...
public final class d {
    ...
    private static long fun1(int[] iArr, int i2, long j2) {
        long j3 = 0;
    ...
    private static void func2(long j2, long[] jArr, int i2) {
        long a2 = fun1(j, 56, j2);
        for (int i3 = 0; i3 < 16; i3++) {
            a2 = ((a2 & (m[l[i3]] ^ -1)) >> l[i3]) | ((m[l[i3]] & a2) << (28 - l[i3]));
            jArr[i3] = fun1(k, 64, a2);
        }
        if (i2 == 1) {
    ...
    private static long func3(long[] jArr, long j2) {
        p = fun1(f4898e, 64, j2);
    ...
    public static synchronized byte[] compressBArr(byte[] bArr, int i2, byte[] bArr2) {
        byte[] bArr3;
        long j2 = 0;
        for (int i4 = 0; i4 < 8; i4++) {
